        ...
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg">
                ...
                <div class="border-b border-gray-200 px-6 py-4">
                    <h2 class="text-xl font-semibold text-gray-900">Tambah Rumah Baru</h2>
                    <p class="mt-1 text-sm text-gray-600">Lengkapi informasi rumah Anda</p>
                </div>

                <form method="post" action="{{ route('admin.houses.store') }}" class="p-6" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="grid gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status"
                                        ...
                                        <option value="dalam_booking">Dalam Booking</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <x-text-input id="bedrooms" name="bedrooms" type="number" min="0"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                                        autocomplete="bedrooms" required />
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="bathrooms" name="bathrooms" type="number" min="0"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                                        autocomplete="bathrooms" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border border-gray-200 rounded-lg p-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description"
                                    class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                                    rows="4"
                                    placeholder="Masukkan deskripsi lengkap rumah..." required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="border border-gray-200 rounded-lg p-6">
                            ...
                            <div class="grid gap-4 md:grid-cols-3">
                                <div class="flex items-center">
                                    <input type="checkbox" id="wifi" name="amenities[]" value="wifi" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="wifi" class="ml-2 text-sm text-gray-700">WiFi</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="ac" name="amenities[]" value="ac" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="ac" class="ml-2 text-sm text-gray-700">AC</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="kitchen" name="amenities[]" value="kitchen" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="kitchen" class="ml-2 text-sm text-gray-700">Dapur</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="parking" name="amenities[]" value="parking" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="parking" class="ml-2 text-sm text-gray-700">Parkir</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="tv" name="amenities[]" value="tv" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="tv" class="ml-2 text-sm text-gray-700">TV</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="pool" name="amenities[]" value="pool" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="pool" class="ml-2 text-sm text-gray-700">Kolam Renang</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="garden" name="amenities[]" value="garden" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="garden" class="ml-2 text-sm text-gray-700">Taman</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="security" name="amenities[]" value="security" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="security" class="ml-2 text-sm text-gray-700">Keamanan 24 Jam</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="laundry" name="amenities[]" value="laundry" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        ...
                        <div class="border border-gray-200 rounded-lg p-6">
                            ...
                            <div class="grid gap-4 md:grid-cols-3">
                                <div class="flex items-center">
                                    <input type="checkbox" id="balcony" name="features[]" value="balcony" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="balcony" class="ml-2 text-sm text-gray-700">Balkon</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="fireplace" name="features[]" value="fireplace" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="fireplace" class="ml-2 text-sm text-gray-700">Perapian</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="gym" name="features[]" value="gym" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="gym" class="ml-2 text-sm text-gray-700">Gym</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="sauna" name="features[]" value="sauna" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="sauna" class="ml-2 text-sm text-gray-700">Sauna</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="bbq" name="features[]" value="bbq" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <label for="bbq" class="ml-2 text-sm text-gray-700">BBQ Area</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="workspace" name="features[]" value="workspace" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
