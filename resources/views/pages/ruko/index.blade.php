...
@section('title', 'Daftar Ruko - CitraGarden')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl font-extrabold text-white sm:text-5xl lg:text-6xl">
                    Daftar Ruko Tersedia
                </h1>
                <p class="mt-4 text-xl text-indigo-100 max-w-3xl mx-auto">
                    Temukan ruko impian Anda dengan berbagai pilihan lokasi, tipe, dan harga yang sesuai kebutuhan bisnis
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white py-8 shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center">Cari & Filter Ruko</h2>
                
                <form action="{{ route('ruko.index') }}" method="GET" class="space-y-6">
                    <!-- Search Bar -->
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Cari Ruko</label>
                            <input type="text" 
                                   name="search" 
                                   value="{{ request('search') }}"
                                   placeholder="Masukkan nama ruko, lokasi, atau deskripsi..." 
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('ruko.index') }}" class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition duration-300 flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Tipe Ruko</label>
                            <select name="type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                ...
                                <option value="ruko_1_lantai" {{ request('type') == 'ruko_1_lantai' ? 'selected' : '' }}>Ruko 1 Lantai</option>
                                <option value="ruko_2_lantai" {{ request('type') == 'ruko_2_lantai' ? 'selected' : '' }}>Ruko 2 Lantai</option>
                                <option value="ruko_3_lantai" {{ request('type') == 'ruko_3_lantai' ? 'selected' : '' }}>Ruko 3 Lantai</option>
                                <option value="ruko_4_lantai" {{ request('type') == 'ruko_4_lantai' ? 'selected' : '' }}>Ruko 4 Lantai</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="price_range" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                ...
                                <option value="under_1b" {{ request('price_range') == 'under_1b' ? 'selected' : '' }}>< 1 Miliar</option>
                                <option value="1b_3b" {{ request('price_range') == '1b_3b' ? 'selected' : '' }}>1 Miliar - 3 Miliar</option>
                                <option value="3b_5b" {{ request('price_range') == '3b_5b' ? 'selected' : '' }}>3 Miliar - 5 Miliar</option>
                                <option value="over_5b" {{ request('price_range') == 'over_5b' ? 'selected' : '' }}>> 5 Miliar</option>
                            </select>
                        </div>
                        <div>
    ...
    <div class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">
                        Ditemukan {{ $ruko->total() }} ruko yang sesuai dengan kriteria Anda
                    </p>
                </div>
            ...
            @if($ruko->count() > 0)
                    ...
                    <div class="group relative bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="w-full h-64 bg-gray-200 overflow-hidden relative">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition duration-300 flex items-center justify-center">
                                <a href="{{ route('ruko.show', $item->id) }}" 
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center text-sm text-gray-500 mb-4 space-x-4">
                                ...
                                <span class="flex items-center">
                                    <i class="fas fa-parking mr-1 text-indigo-500"></i>
                                    {{ $item->parking }} Parkir
                                </span>
                            </div>
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-2xl font-bold text-indigo-600">{{ $item->formatted_price }}</p>
                ...
                @if($ruko->hasPages())
                <div class="mt-12">
                    {{ $ruko->appends(request()->query())->links() }}
                </div>
                @endif
            ...
            @else
                ...
                <div class="text-center py-16">
                    <div class="max-w-md mx-auto">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 mb-2">Tidak ada ruko ditemukan</h3>
                        <p class="text-gray-500 mb-6">
                            Maaf, tidak ada ruko yang sesuai dengan kriteria pencarian Anda. 
    ...
    <div class="bg-indigo-600 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl font-bold text-white mb-4">
                Butuh Bantuan Mencari Ruko?
            </h2>
            <p class="text-indigo-100 mb-8 max-w-2xl mx-auto">
                Tim kami siap membantu Anda menemukan ruko yang tepat sesuai dengan kebutuhan dan budget bisnis Anda.
            </p>
